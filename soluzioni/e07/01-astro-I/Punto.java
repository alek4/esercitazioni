...
public record Punto(int x, int y, int z) {
  ...
  // EFFECTS: restituisce un nuovo punto ottenuto sommando questo e il punto dato come
  ...
  // EFFECTS: restituisce un nuovo punto ottenuto sottraendo da questo il punto dato come
  //          argomento (sollevando eccezione qualora quest'ultimo sia null)
  ...
  // EFFECTS: la norma, come da definizione
  public int norma() {
